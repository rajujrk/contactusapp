...
public class ContactDetailsController {
    ...
    public ResponseEntity<ResponseMetaData> saveContactDetails(@RequestBody ContactDetailsRequest contactDetailsRequest, HttpServletRequest httpServletRequest) {
